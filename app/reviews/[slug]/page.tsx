...
export default async function ReviewPage({
  ...
  const structuredData = {
    ...
    itemReviewed: {
      "@type":
        itemType === "videogame" || itemType === "boardgame"
          ...
          : itemType === "movie"
          ? "Movie"
          : itemType === "tvseries" || itemType === "anime"
          ? "TVSeries"
    ...
    author: {
      ...
      url: review.author?.slug?.current
        ? `https://lifemeetspixel.com/author/${review.author.slug.current}`
        : undefined,
    },
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {review.categories?.map((category: Category) => (
                  <Badge
                    key={
                      category._id || category.slug?.current || category.title
                    }
